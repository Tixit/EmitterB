...
function doyourthang(watch) {
    build(name+".browser", watch, {name: name, output: {path:__dirname+'/../../dist/', name: name+".umd.js"}})
    build(name+".browser", watch, {name: name, minify: false, output: {path:__dirname+'/../../dist/', name: name+".dev.umd.js"}})
